class Model{
  ...
  float _time_cache_pointing(int distance_from_top_of_cache){
     return this.A + this.B*(float)(Math.log((distance_from_top_of_cache/INITIAL_ITEM_HEIGHT)+1) / Math.log(2));
  }

  float _time_for_cache(int cacheSize, int distance_from_top_of_cache){
  ...
  float _time_menu_pointing(int distance_from_top_of_cache, int distance_from_top_of_top_of_menu, float target_height){
  ...
  float _time_for_menu(float expertise, int num_menu_items, int distance_from_top_of_cache, int distance_from_top_of_menu, float target_height){
  ...
  int get_estimate(float expertise, int cache_size, int distance_from_top_of_cache, int num_menu_items, int distance_from_top_of_menu, float target_height){
